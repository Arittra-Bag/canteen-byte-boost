...
import { getAllMenuItems, saveMenuItem, deleteMenuItem } from "@/services/supabaseData";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editingItem) {
        ...
        const savedItem = await saveMenuItem(updatedItem);
        ...
        const newItem: MenuItem = {
          ...
          available: formData.available,
          popular: formData.popular,
          canteenId: "c1", // Default canteen ID - in a real app, get this from user context
        };
        ...
        toast({
          ...
          description: `${savedItem.name} has been added to your menu.`,
        });
      }
